...
public static class Helpers
{
    ...
    /// <returns></returns>
    public static Dictionary<Type, IList> RecordsDeserialization(
        Dictionary<string, IEnumerable<RedisValue>> redisValueDictionary,
        ILogger logger
    )
    {
        Dictionary<string, IList> di = Helpers
            .GetAllAnalyticRecordTypes()
            .ToDictionary(
