...
{
    /// <inheritdoc />
    public partial class create_ProcessCorrelatedPageAnalyticsBatch_procedure : Migration
    {
        /// <inheritdoc />
...
/*
    * The goals of this Procedure are:
        - joined uncorrelated from staged tables and insert them into PageAnalytical.
        - Join distinct keys from temp table with exist keys in TimeInterval and insert the result into AggregateRecomputeQueue.

    * Steps
      1- Create Temp Table
      2- Joining the uncorrelated data from PSARecords + GARecords
      3- Insert joined data into temp table
      4- Mark Staged Rows As Correlated
      5- Drop the temp table

*/

            var processCorrelatedPageAnalyticsBatch = """
            ...
            migrationBuilder.Sql(processCorrelatedPageAnalyticsBatch);
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            var dropProcessCorrelatedPageAnalyticsBatch = """
                                                          DROP PROCEDURE ProcessCorrelatedPageAnalyticsBatch;
                                                          """;

            migrationBuilder.Sql(dropProcessCorrelatedPageAnalyticsBatch);
        }
    }
}
